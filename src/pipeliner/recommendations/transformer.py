...
class UserItemMatrixTransformer(BaseEstimator, TransformerMixin):
    """
...
class SimilarityTransformer(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, kind="user", metric="cosine"):
    ...
    def transform(self, X):
        ...
        if self.metric == "cosine":
            ...
            raise NotImplementedError(
                "Only cosine similarity and distance are currently supported"
            )
