...
def test_EvaluationDataset(fx_user_item_ratings_toy):
    dataset = EvaluationDataset(fx_user_item_ratings_toy)
    assert dataset.full.shape == fx_user_item_ratings_toy.shape

def test_EvaluationDataset_anti_testset(fx_user_item_ratings_toy):
    dataset = EvaluationDataset(fx_user_item_ratings_toy)
...
def test_EvaluationDataset_anti_testset_cached(fx_user_item_ratings_toy):
    dataset = EvaluationDataset(fx_user_item_ratings_toy)
...
def test_EvaluationDataset_leave_one_out(fx_user_item_ratings_toy):
    dataset = EvaluationDataset(fx_user_item_ratings_toy)
...
def test_EvaluationDataset_leave_one_out_random_seed(mocker, fx_user_item_ratings_toy):
...
def test_EvaluationDataset_leave_one_out_min_ratings_error(fx_user_item_ratings_toy):
    dataset = EvaluationDataset(fx_user_item_ratings_toy, min_user_ratings=20, min_item_ratings=20)
    leave_one_out = dataset.leave_one_out()
