...
def test_encode_labels():
    ...
    assert set(user_encoder.inverse_transform(encoded_df['user_id'])) == {'user1', 'user2', 'user3'}
    assert set(item_encoder.inverse_transform(encoded_df['item_id'])) == {'item1', 'item2', 'item3'}
